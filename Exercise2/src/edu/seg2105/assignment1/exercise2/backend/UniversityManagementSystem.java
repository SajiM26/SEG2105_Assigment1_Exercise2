...
public class UniversityManagementSystem {
	...
	public void processCreateEmployee(String entity, String firstName, String lastName, double salary) {
		...
		if (entity.startsWith("PROFESSOR"))
			...
			// TODO Add code for the TA employee, entity.startsWith("TA") not necessary as commandline has input validation
			employee = new TeachingAssistant(firstName, lastName, id, salary); // This line is temporary (should be changed once you add the TA employee functionality
		}
	...
	public void processListEmployees(String entity) {
		...
		for (Employee employee : employees) {
			if (entity.startsWith("EMPLOYEE") || // print all employees if the entity is employee
				...
				entity.startsWith("TA") && employee instanceof TeachingAssistant // TODO add a condition for the TA
				)
	...
	public void processAssignAdministrator(String id, String task) {
		...
		admin.addTask(task);
		/*Unsure if allowed, but if addTask returned a boolean I could print the statement using ui
		validation should be done within a class for encapsulation 
		*/
		return;
