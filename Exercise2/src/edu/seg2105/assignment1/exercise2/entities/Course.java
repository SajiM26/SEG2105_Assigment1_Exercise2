...
public class Course {
    ...
    //The Ta of this course --> only 1 allowed
    ...
    /**
     * Gets the TA teaching the course.
     *
     * @return the ta
     */
    ...
    private String getProfessorName() {
        ...
        /**
     * Gets the name of the TA teaching the course.
     *
     * @return the TA's full name or "Not yet assigned" if no TA is set
     */
    ...
    public String toString() {
        return "Course information:\n"
                ...
                + "\tCourse Teaching Assistant: " + getTAName() + "\n"
